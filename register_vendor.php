    ...
    if (empty($username) || empty($email) || empty($password) || empty($full_name) || empty($store_name)) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                // Insert user as vendor
                $password_hash = password_hash($password, PASSWORD_DEFAULT);
                $stmt = $pdo->prepare("
                    INSERT INTO users (username, email, password_hash, full_name, phone, user_type, vendor_status) 
                ...
                $stmt = $pdo->prepare("
                    INSERT INTO vendor_profiles (user_id, store_name, store_description, store_address, store_phone) 
                    VALUES (?, ?, ?, ?, ?)
                ");
...
<head>
    ...
    <title>Become a Vendor - MarketPK</title>
    ...
    <style>
        ...
        .vendor-register-container h2 {
            color: #0066CB;
            text-align: center;
            margin-bottom: 10px;
        }
        .vendor-register-container .subtitle {
            text-align: center;
            color: #888;
            margin-bottom: 30px;
        }
        ...
        .vendor-register-container .btn-primary:hover {
            background: #0044aa;
        }
        .vendor-register-container a {
            color: #0066CB;
            text-decoration: none;
        }
        .vendor-register-container a:hover {
            color: #FF636B;
        }
        ...
        <div class="vendor-register-container">
            ...
            <?php if ($success): ?>
                <div class="success-page">
                    ...
                    <p class="text-muted">Our team will review your application and get back to you within 24-48 hours.</p>
                    <div class="mt-3">
            ...
            <?php else: ?>
                ...
                <p class="subtitle">Start selling your products to thousands of customers</p>
                ...
                <form method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="store_description" rows="3" placeholder="Tell us about your store..."></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                ...
                <div class="text-center mt-3">
                    <p>Already have an account? <a href="vendor_login.php">Login to Vendor Dashboard</a></p>
