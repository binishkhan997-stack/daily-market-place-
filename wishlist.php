...
<head>
    ...
    <title>My Wishlist - MarketPK</title>
    ...
    <style>
        ...
        .wishlist-item .details .name:hover {
            color: #FF636B;
        }
        .wishlist-item .details .vendor {
            font-size: 0.85rem;
            color: #888;
        }
        .wishlist-item .price {
        ...
        .wishlist-item .actions .btn-cart:hover {
            background: #0066CB;
        }
        ...
        <?php else: ?>
            ...
            ?>
                <div class="wishlist-item">
                    ...
                    <div class="details">
                        <a href="product.php?slug=<?php echo $item['slug']; ?>" class="name">
                        ...
                        <div class="mt-1">
                            <?php if ($item['discount_price']): ?>
                                <span class="text-muted text-decoration-line-through me-2">PKR <?php echo number_format($item['price']); ?></span>
                                <span class="price">PKR <?php echo number_format($item['discount_price']); ?></span>
                            <?php else: ?>
                                <span class="price">PKR <?php echo number_format($item['price']); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
